...
/*------------------------------------------------------------------------------
  ...
  $payments_query = xtc_db_query("select * from " . TABLE_AFFILIATE_PAYMENT . " where affiliate_payment_id = '" . $_GET['pID'] . "'");
  $payments = xtc_db_fetch_array($payments_query);
...
<table border="0" width="100%" cellspacing="0" cellpadding="2">
  <tr>
    <td><table border="0" width="100%" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td class="pageHeading" align="right"><?php echo xtc_image(DIR_WS_IMAGES . 'logo.gif', 'neXTCommerce', '185', '95'); ?></td>
      </tr>
    </table></td>
  </tr>
  <tr>
    <td><table width="100%" border="0" cellspacing="0" cellpadding="2">
      <tr>
        <td><?php echo xtc_draw_separator(); ?></td>
      </tr>
      <tr>
  ...
  <tr>
    <td><?php echo xtc_draw_separator('pixel_trans.gif', '1', '20'); ?></td>
  </tr>
  <tr>
...
<?php
  $affiliate_payment_query = xtc_db_query("select * from " . TABLE_AFFILIATE_PAYMENT . " where affiliate_payment_id = '" . $_GET['pID'] . "'");
  $affiliate_payment = xtc_db_fetch_array($affiliate_payment_query);
  $affiliate_sales_query = xtc_db_query("select * from " . TABLE_AFFILIATE_SALES . " where affiliate_payment_id = '" . $payments['affiliate_payment_id'] . "' order by affiliate_payment_date desc");
  while ($affiliate_sales = xtc_db_fetch_array($affiliate_sales_query)) {
?>
