      ...
      <tr>
        <td width="100%"><table border="0" width="100%" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td class="pageHeading" align="right"><?php echo '<a href="' . xtc_href_link(FILENAME_AFFILIATE, xtc_get_all_get_params(array('action'))) . '">' . xtc_image_button('button_back.gif', IMAGE_BACK) . '</a>'; ?></td>
          </tr>
        </table></td>
      </tr>
      <tr>
            ...
            <td><table width="100%" border="0" cellpadding="4" cellspacing="2" class="dataTableContent">
              <center>
                <tr>
                  ...
                  <td width="15%" class="dataTableContent"><?php echo xtc_date_short($affiliate['affiliate_date_account_created']); ?></td>
                </tr>
                <tr>
                ...
                <tr>
                  <td align="right" class="dataTableContent" colspan="4"><?php echo '<a href="' . xtc_href_link(FILENAME_AFFILIATE_CLICKS, 'acID=' . $_GET['acID']) . '">' . xtc_image_button('button_affiliate_clickthroughs.gif', IMAGE_CLICKTHROUGHS) . '</a> <a href="' . xtc_href_link(FILENAME_AFFILIATE_SALES, 'acID=' . $_GET['acID']) . '">' . xtc_image_button('button_affiliate_sales.gif', IMAGE_SALES) . '</a>'; ?></td>
                </tr>
              </center>
            </table></td>
          </tr>
