...
/*------------------------------------------------------------------------------
  ...
  if (AFFILIATE_DELETE_CLICKTHROUGHS != 'false' && is_numeric(AFFILIATE_DELETE_CLICKTHROUGHS)) {
    ...
    xtc_db_query("delete from " . TABLE_AFFILIATE_CLICKTHROUGHS . " where affiliate_clientdate < '". $time . "'");
  }
  ...
  if (AFFILIATE_DELETE_AFFILIATE_BANNER_HISTORY != 'false' && is_numeric(AFFILIATE_DELETE_AFFILIATE_BANNER_HISTORY)) {
    ...
    $time = date("Y-m-d", $time);
    xtc_db_query("delete from " . TABLE_AFFILIATE_BANNERS_HISTORY . " where affiliate_banners_history_date < '". $time . "'");
  }
  ...
  $affiliates_raw_query = xtc_db_query($affiliates_raw);
  $affiliates_raw = xtc_db_fetch_array($affiliates_raw_query);
            ...
            <td><table width="100%" border="0" cellpadding="4" cellspacing="2" class="dataTableContent">
              <center>
                ...
                <tr>
                  ...
                  <td width="15%" class="dataTableContent"><?php echo xtc_round(AFFILIATE_PERCENT, 2) . ' %'; ?></td>
                ...
                <tr>
                  <td colspan="4"><?php echo xtc_draw_separator(); ?></td>
                </tr>
                <tr>
                ...
                <tr>
                  <td align="right" class="dataTableContent" colspan="4"><?php echo '<a href="' . xtc_href_link(FILENAME_AFFILIATE_BANNERS, '') . '">' . xtc_image_button('button_affiliate_banners.gif', IMAGE_BANNERS) . '</a> <a href="' . xtc_href_link(FILENAME_AFFILIATE_CLICKS, '') . '">' . xtc_image_button('button_affiliate_clickthroughs.gif', IMAGE_CLICKTHROUGHS) . '</a> <a href="' . xtc_href_link(FILENAME_AFFILIATE_SALES, '') . '">' . xtc_image_button('button_affiliate_sales.gif', IMAGE_SALES) . '</a>'; ?></td>
                </tr>
              </center>
            </table></td>
          </tr>
